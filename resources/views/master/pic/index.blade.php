                ...
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <a href="#" class="btn btn-sm btn-soft-primary" data-bs-toggle="modal" data-bs-target="#ModalPIC">
                            <i class="bx bx-plus me-1"></i>Assign PIC
                        </a>
                    </div>
                </div>
                <!-- end card body -->
                        ...
                        <div class="modal-body">
                            <form action="{{ route('pic.dataupdate') }}" method="POST" id="ModalPIC">
                                ...
                                <div class="mb-2">
                                    ...
                                    <select name="name" class="form-control" id="" data-choices data-choices-groups required>
                                ...
                                <div class="mb-2">
                                    ...
                                    <select name="divisi" class="form-control" id="" data-choices data-choices-groups required>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('pic.update', $data->id)}}" method="POST" id="ModalPIC{{$data->id}}">
                                ...
                                <div class="mb-2">
                                    <label for="" class="form-label">Nama Karyawan</label>
                                    <input type="text" name="name2" class="form-control" value="{{$data->name}}" readonly>
                                    <input type="hidden" name="name" class="form-control" value="{{$data->id}}" >
                                </div>

                                <div class="mb-2">
                                    <label for="" class="form-label">Divisi</label>
                                    <select name="divisi" class="form-control" data-choices data-choices-groups required>
                                        <option value="">Pilih Divisi</option>
                                        @foreach($divisi as $div)
