@extends('layouts.vertical', ['title' => 'Data Divisi'])
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <a href="#" class="btn btn-sm btn-soft-primary" data-bs-toggle="modal" data-bs-target="#ModalDivisi">
                            <i class="bx bx-plus me-1"></i>Buat Divisi
                        </a>
                    </div>
                </div>
                <!-- end card body -->
                ...
                <div id="table-search">
                    ...
                    <tfoot>
                        <div class="d-flex justify-content-between mx-3 mt-2 mb-2">
                            ...
                            <div class="">
                                {{ $divisi->links('pagination::bootstrap-4') }}  <!-- Pagination links -->
                            </div>
                        </div>
                    </tfoot>
                </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('divisi.store')}}" method="POST" id="ModalDivisi">
                                @csrf
            ...
            <div class="modal fade" id="ModalDivisiUpdate{{$data->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('divisi.update', $data->id)}}" method="POST" id="ModalDivisi">
                                @csrf
                                @method('PUT')
                                <div class="mb-2">
                                    <label for="" class="form-label">Nama Divisi</label>
    ...
    <script>
        ...
        // Trigger an AJAX request on keyup event
            $('#search-input').on('keyup', function() {
                ...
                $.ajax({
                    url: "{{ route('divisi.index') }}",  // Route for user list
                    method: 'GET',
                    data: { 
